...
refresh_compile_commands(
    ...
    # To omit entries for sources (not headers - see below) from external workspaces (dependencies)
    ...
    exclude_headers = "external"    - Excludes all headers from external workspaces and other non-workspace headers (/usr/include, etc.)
                                      Headers in your workspace, as well as any generated by your build (in bazel-out, for ex) will still be included
